...
const Model = ({ imageDetails }) => {
  ...
  return (
    ...
    >
      ...
      {/* animate: Values to animate to, variant label(s), or AnimationControls. */}
...
// Variants: Target objects are useful for simple, single-component animations. But sometimes we want to create animations that propagate throughout the DOM, and orchestrate those animations in a declarative way. We can do so with variants.
